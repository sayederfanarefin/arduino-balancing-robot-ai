...
#define leftMotorGNDPin 7


#define rightMotorPWMPin 5
#define rightMotorDirPin 3
#define rightMotorGNDPin 4
...
void setMotors(int leftMotorSpeed, int rightMotorSpeed)
{
    ...
    if (leftMotorSpeed >= 0)
    {
        ...
        digitalWrite(leftMotorGNDPin, HIGH); // added later
    }

    else
    { // if leftMotorSpeed is < 0 then set dir to reverse

        analogWrite(leftMotorPWMPin, 255 + leftMotorSpeed);

        digitalWrite(leftMotorDirPin, HIGH);
        digitalWrite(leftMotorGNDPin, LOW); // added later
    }
    ...
    if (rightMotorSpeed >= 0)
    {
        ...
        digitalWrite(rightMotorGNDPin, HIGH); // added later
    }
    ...
    else
    {
        ...
        digitalWrite(rightMotorGNDPin, LOW); // added later
    }
}
...
void setup()
{
    ...
    mpu.setYAccelOffset(-762); // from calibration routine

    mpu.setZAccelOffset(646);

    mpu.setXAccelOffset(-5484);

    mpu.setXGyroOffset(-1);
    mpu.setYGyroOffset(24);
    mpu.setZGyroOffset(-8);

    Serial.print("End Initialize MPU at: ");
...

{
    ...
    while (Error < Success)
    {
        ...
        { // do calculation every 5 or more milliseconds
